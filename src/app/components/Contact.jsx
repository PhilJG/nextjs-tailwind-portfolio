...
const ContactPage = () => {
    return (
        <section id="contact">
            ...
            <form action="https://formsubmit.co/me@philjgray.ca" method="POST" className="form">
                <label htmlFor="">Name</label>
                <br />
                <input className="border font-bold text-lg  rounded-md px-2 py-1 w-full dark:bg-transparent" placeholder="Jane Appleseed" type="text" name="name" required />
                <br />
                <label htmlFor="">Email</label>
                <br />

                <input className="border font-bold text-lg  rounded-md px-2 py-1 w-full dark:bg-transparent" placeholder="example@email.com" type="email" name="email" required />
                <br />
                <label htmlFor="">Message</label>
                <br />
                <textarea className="border font-bold text-lg  rounded-md px-2 py-1 w-full dark:bg-transparent" placeholder="How can I help" type="text" name="message" required></textarea>
